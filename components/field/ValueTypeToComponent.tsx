...
const ValueTypeToComponentMap: Record<ProFieldBuiltinValueType, ProRenderFieldPropsType> = {
  ...
  date: sameRenderPair((text, props) =>
    wrapProFieldLight(props.light, <FieldDatePicker format="YYYY-MM-DD" {...props} text={text} />),
  ),
  dateWeek: sameRenderPair((text, props) =>
    wrapProFieldLight(props.light, <FieldDatePicker format="gggg-wo" picker="week" {...props} text={text} />),
  ),
  ...
  dateMonth: sameRenderPair((text, props) =>
    wrapProFieldLight(props.light, <FieldDatePicker format="YYYY-MM" picker="month" {...props} text={text} />),
  ),
  dateQuarter: sameRenderPair((text, props) =>
    wrapProFieldLight(props.light, <FieldDatePicker format="YYYY-[Q]Q" picker="quarter" {...props} text={text} />),
  ),
  dateYear: sameRenderPair((text, props) =>
    wrapProFieldLight(props.light, <FieldDatePicker format="YYYY" picker="year" {...props} text={text} />),
  ),
  dateRange: sameRenderPair((text, props) => <FieldRangePicker format="YYYY-MM-DD" {...props} text={text} />),
  dateTime: sameRenderPair((text, props) =>
    wrapProFieldLight(props.light, <FieldDatePicker format="YYYY-MM-DD HH:mm:ss" showTime {...props} text={text} />),
  ),
  dateTimeRange: sameRenderPair((text, props) =>
    wrapProFieldLight(props.light, <FieldRangePicker format="YYYY-MM-DD HH:mm:ss" showTime {...props} text={text} />),
  ),
  time: sameRenderPair((text, props) =>
    wrapProFieldLight(props.light, <FieldTimePicker format="HH:mm:ss" {...props} text={text} />),
  ),
  timeRange: sameRenderPair((text, props) =>
    wrapProFieldLight(props.light, <FieldTimeRangePicker format="HH:mm:ss" {...props} text={text} />),
  ),
  ...
  checkbox: sameRenderPair((text, props) => <FieldCheckbox {...props} text={text} />),
  radio: sameRenderPair((text, props) => <FieldRadio {...props} text={text} />),
  radioButton: sameRenderPair((text, props) => <FieldRadio radioType="button" {...props} text={text} />),
  rate: sameRenderPair((text, props) => <FieldRate {...props} text={text} />),
  slider: sameRenderPair((text, props) => <FieldSlider {...props} text={text} />),
  switch: sameRenderPair((text, props) => <FieldSwitch {...props} text={text} />),
  option: sameRenderPair((text, props) => <FieldOptions {...props} text={text} />),
  password: sameRenderPair((text, props) => <FieldPassword {...props} text={text} />),
  ...
  segmented: sameRenderPair((text, props) => <FieldSegmented {...props} text={text} />),
}
